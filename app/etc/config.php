...
return [
    'modules' => [
        ...
        'RLTSquare_CategoryIcon' => 0,
        'RLTSquare_CustomAttributes' => 1,
        'RLTSquare_CustomImportExport' => 1,
        'RLTSquare_GetProductByCategoryID' => 1,
        'RLTSquare_SubCategorySlider' => 1,
        'RLTSquare_WhatsAppChat' => 1,
        'RLTSquare_YouTubeVideoSliderPopup' => 1,
        'Smartwave_Core' => 1,
